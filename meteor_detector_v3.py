...
# Tighter audio band
DETECTION_MIN_HZ = 1300
DETECTION_MAX_HZ = 1700

# Triggering
TRIGGER_DB_ABOVE_BASELINE = 12.0
...
def utc_iso_from_ts(ts: float) -> str:
    # return datetime.fromtimestamp(ts, timezone.utc).isoformat() # Returns records with UTC time
